...
<style type="text/css">
	...
	.login_box{background:url(<?php echo IMG_PATH?>admin_img/login_bg1.jpg) no-repeat; width:602px; height:416px; overflow:hidden; position:absolute; left:50%; top:50%; margin-left:-301px; margin-top:-208px}
